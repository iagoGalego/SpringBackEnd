...
public class ChooseVariousOptionsQuestionAnswer extends Answer {
	private static final long serialVersionUID = 1L;
	public static final String RDFS_CLASS = "http://citius.usc.es/hmb/citius.owl#ChooseVariousOptionsQuestionAnswer";
	private java.util.List<Option> solutions = new java.util.ArrayList<>();

	public ChooseVariousOptionsQuestionAnswer() {
		super();
	}

	public ChooseVariousOptionsQuestionAnswer(String uri) {
		super(uri, false);
	}

	public ChooseVariousOptionsQuestionAnswer(String uri, boolean b) {
		super(uri, false);
	}
