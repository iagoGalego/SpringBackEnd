...
public class InsertVariousTextsQuestionAnswer extends Answer {
	private static final long serialVersionUID = 1L;
	public static final String RDFS_CLASS = "http://citius.usc.es/hmb/citius.owl#InsertVariousTextsQuestionAnswer";
	private java.util.List<es.usc.citius.hmb.model.StringType> solutions = new java.util.ArrayList<>();

	public InsertVariousTextsQuestionAnswer() {
		super();
	}

	public InsertVariousTextsQuestionAnswer(String uri) {
		super(uri, false);
	}

	public InsertVariousTextsQuestionAnswer(String uri, boolean b) {
		super(uri, false);
	}
